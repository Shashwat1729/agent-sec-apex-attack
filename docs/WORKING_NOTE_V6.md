# Throughput-First Red-Teaming of Multi-Step Tool Agents: Exploiting the Outbound-Payload Blind Spot (V6: The Full Field Inline - 810 Weighted, 1st-Position Target)
...
- Rank 6, hiranorm/publiclb-95-130-privatelb-0-00-aas-mf-k8-ff-test, 1 vote —
  — NEUTRAL. Title-claimed 95.130 pub / 0.00 priv; cautionary public-only max-fill exemplar v64 rejected.
...
- Rank 49, caoyupeng/lb-66-015-from-kun-zhang, 51 votes —
  — NEUTRAL. Kun Zhang fork, title-claimed 66.015; stale July fill.
...
| Figure 8 | assets/private_scatter.png | §6/§10 | Public-vs-private collapse; rank 6 (95.130 public, 0.00 private) is the extreme point of the same cloud |
...
| 694 | municef1/105-silver-private-lb-22-155-confused-deputy | #105 Silver: Private LB 22.155 Confused Deputy | 안녕하세요이세입니다잘부탁드립니다 | 4 | INFERRED-tail |
...
- rank 49 `caoyupeng/lb-66-015-from-kun-zhang` (51 votes) - Kun Zhang fork, title-claimed 66.015; stale July fill. [keep-as-lottery-only]
...
- rank 6 `hiranorm/publiclb-95-130-privatelb-0-00-aas-mf-k8-ff-test` (1 votes) - Title-claimed 95.130 pub / 0.00 priv; cautionary public-only max-fill exemplar v64 rejected. [never-retry]
